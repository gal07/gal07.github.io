                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="blog__content">
                                                <a class="link--gray" href=""><h3 class="blog__title">Consectetur Adipisicing</h3></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="blog__content">
                                                ...
                                                <div class="blog__archive m-t-20">
                                                    <a href="#" class="link--gray link--icon-left m-r-30"><i class="far fa-calendar"></i> Jul 9, 2018</a>
                                            <a href="#" class="link--gray link--icon-left"><i class="far fa-user"></i> Jhon Doe</a>
                                                </div>
                                                <div class="para m-tb-20">
                                                    <p class="para__text">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="blog__content">
                                                ...
                                                <div class="blog__archive m-t-20">
                                                    <a href="#" class="link--gray link--icon-left m-r-30"><i class="far fa-calendar"></i> Mar 3, 2018</a>
                                                    <a href="#" class="link--gray link--icon-left"><i class="far fa-user"></i> Jhon Doe</a>
                                                </div>
                                                <div class="para m-tb-20">
                                                    <p class="para__text">
                            ...
                            <div class="col-12">
                                <div class="blog__type-list">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="blog__content">
                                                <a class="link--gray" href=""><h3 class="blog__title">Remaining Essential Foods</h3></a>
                                                <div class="blog__archive m-t-20">
                                                    <a href="#" class="link--gray link--icon-left m-r-30"><i class="far fa-calendar"></i> Feb 11, 2018</a>
                                                    <a href="#" class="link--gray link--icon-left"><i class="far fa-user"></i> Jhon Doe</a>
                                                </div>
                                                <div class="para m-tb-20">
                                                    <p class="para__text">
